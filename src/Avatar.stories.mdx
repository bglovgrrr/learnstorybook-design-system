...
<Preview withToolbar>
  <Story name="standard">
    <Avatar
      ...
      src="https://lh3.googleusercontent.com/-qfUjkYZbYG8/AAAAAAAAAAI/AAAAAAAAAAA/ACHi3rcVZgaDVcevS3RCGyOf4lcjKa8I3A.CMID/s64-c/photo.jpg"
    />
  </Story>
</Preview>
...
<Story name="knobs" parameters={{ decorators: [withKnobs] }}>
  <Avatar
    ...
    username="Brian GLover"
    src="https://lh3.googleusercontent.com/-O3C9B-z5Yis/AAAAAAAAAAI/AAAAAAAAAAA/ACHi3rf79w7JZaXuQUXuI8TmLyV00Uk_1Q.CMID/s64-c/photo.jpg"
  />
</Story>
